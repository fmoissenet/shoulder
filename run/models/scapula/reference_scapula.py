    ...
    if use_precomputed_values:
        ...
        if filename == "PJ151-M001-scapula.ply":
            ...
            landmarks["GC_LOWER_CONTOURS"] = [
                np.array([-56.2308, -61.5987, 1439.301]),
                np.array([-56.4361, -62.2529, 1436.616]),
                np.array([-57.3594, -62.3586, 1434.808]),
                np.array([-55.3643, -62.4763, 1433.672]),
                np.array([-56.6862, -63.0425, 1431.234]),
                np.array([-57.2722, -63.0622, 1429.959]),
                np.array([-55.6309, -63.3326, 1428.933]),
                np.array([-54.5774, -63.5185, 1426.206]),
                np.array([-54.5774, -63.5185, 1426.206]),
                np.array([-54.0386, -63.5486, 1423.879]),
                np.array([-50.103, -63.4075, 1421.618]),
                np.array([-50.103, -63.4075, 1421.618]),
                np.array([-46.9866, -63.064, 1420.108]),
                np.array([-44.6287, -62.5683, 1420.276]),
                np.array([-43.8635, -62.3622, 1419.485]),
                np.array([-41.9911, -61.9065, 1420.351]),
                np.array([-41.1045, -61.5696, 1419.332]),
                np.array([-39.3709, -61.2892, 1420.3]),
                np.array([-37.4389, -60.5984, 1421.458]),
                np.array([-35.5047, -59.8735, 1422.494]),
                np.array([-34.7268, -59.2363, 1425.04]),
                np.array([-32.8051, -58.6088, 1425.966]),
                np.array([-31.9408, -58.1552, 1426.773]),
            ]
